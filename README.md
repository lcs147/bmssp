...
| :---                  | :---              | :---                  | :---            | :---            |
|2<sup>12</sup>|3 * 2<sup>12</sup>|0.432|1.818|4.2|
|2<sup>15</sup>|3 * 2<sup>15</sup>|4.675|16.356|3.4|
|2<sup>20</sup>|3 * 2<sup>20</sup>|421.216|1286.205|3.0|
|2<sup>25</sup>|3 * 2<sup>25</sup>|21812.125|82592.131|3.7|

A more detailed performance benchmark (and implementation details) can be found in [https://arxiv.org/abs/2511.03007](https://arxiv.org/abs/2511.03007)
## Requirements
...
*   `std::vector<int> get_shortest_path(int destination, const std::vector<int> &predecessor)`: Returns a shortest path from `s` to `destination` via the `predecessor` list generated by `execute(s)`.

## How to Run Tests and a Small Benchmark
